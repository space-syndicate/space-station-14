...
ent-ToyFigurineHeadOfPersonnel = head of service figure
...
ent-ToyFigurineCaptain = head of station figure
    .desc = A figurine depicting the standard outfit of a head of station belonging to a civilian-sector Nanotrasen vessel.
...
ent-ToyFigurineQuartermaster = head of supply figure
    .desc = A figurine depicting the glorious head of the Cargo department.
ent-ToyFigurineChiefEngineer = head of singularity figure
...
ent-ToyFigurineResearchDirector = head of science figure
...
ent-ToyFigurineChiefMedicalOfficer = head of still just a week away figure
