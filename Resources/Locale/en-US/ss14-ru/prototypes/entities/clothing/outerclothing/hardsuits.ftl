...
ent-ClothingOuterHardsuitCap = head of station's armored spacesuit
    .desc = A formal armored spacesuit, made for the head of station.
ent-ClothingOuterHardsuitEngineeringWhite = head of singularity's hardsuit
    .desc = A special hardsuit that protects against hazardous, low pressure environments, made for the head of singularity of the station.
ent-ClothingOuterHardsuitMedical = head of still just a week away's hardsuit
...
ent-ClothingOuterHardsuitLuxury = luxury mining hardsuit
    .desc = A refurbished mining hardsuit, fashioned after the Head of Supply's colors. Graphene lining provides less protection, but is much easier to move.
