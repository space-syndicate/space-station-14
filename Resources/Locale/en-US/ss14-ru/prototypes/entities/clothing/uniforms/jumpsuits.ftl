...
ent-ClothingUniformJumpsuitCaptain = head of station's jumpsuit
    .desc = It's a blue jumpsuit with some gold markings denoting the rank of "Head of Station".
...
ent-ClothingUniformJumpsuitChiefEngineer = head of singularity's jumpsuit
    .desc = It's a high visibility jumpsuit given to those engineers insane enough to achieve the rank of Head of Singularity. It has minor radiation shielding.
ent-ClothingUniformJumpsuitChiefEngineerTurtle = head of singularity's turtleneck
...
ent-ClothingUniformJumpsuitCMO = head of still just a week away's jumpsuit
    .desc = It's a jumpsuit worn by those with the experience to be Head of Still Just a Week Away. It provides minor biological protection.
...
ent-ClothingUniformJumpsuitHoP = head of service's jumpsuit
...
ent-ClothingUniformJumpsuitPrisoner = prisoner jumpsuit
    .desc = Busted.
ent-ClothingUniformJumpsuitQM = head of supply's jumpsuit
    .desc = What can brown do for you?
ent-ClothingUniformJumpsuitQMTurtleneck = head of supply's turtleneck
    .desc = A sharp turtleneck made for the hardy work environment of supply.
ent-ClothingUniformJumpsuitQMFormal = head of supply's formal suit
    .desc = Inspired by the heads of supply of military's past, the perfect outfit for supplying a formal occasion.
ent-ClothingUniformJumpsuitResearchDirector = head of science's turtleneck
    .desc = It's a turtleneck worn by those with the know-how to achieve the position of Head of Science. Its fabric provides minor protection from biological contaminants.
