...
ent-ClothingUniformJumpskirtCaptain = head of station's jumpskirt
    .desc = It's a blue jumpskirt with some gold markings denoting the rank of "Head of Station".
ent-ClothingUniformJumpskirtCargo = cargo tech jumpskirt
    .desc = A sturdy jumpskirt, issued to members of the Cargo department.
ent-ClothingUniformJumpskirtChiefEngineer = head of singularity's jumpskirt
    .desc = It's a high visibility jumpskirt given to those engineers insane enough to achieve the rank of Head of Singularity. It has minor radiation shielding.
ent-ClothingUniformJumpskirtChiefEngineerTurtle = head of singularity's turtleneck
...
ent-ClothingUniformJumpskirtCMO = head of still just a week away's jumpskirt
    .desc = It's a jumpskirt worn by those with the experience to be Head of Still Just a Week Away. It provides minor biological protection.
...
ent-ClothingUniformJumpskirtHoP = head of service's jumpskirt
...
ent-ClothingUniformJumpskirtPrisoner = prisoner jumpskirt
    .desc = Busted.
ent-ClothingUniformJumpskirtQM = head of supply's jumpskirt
    .desc = What can brown do for you?
ent-ClothingUniformJumpskirtQMTurtleneck = head of supply's turtleneck
    .desc = A sharp turtleneck made for the hardy work environment of supply.
ent-ClothingUniformJumpskirtResearchDirector = head of science's turtleneck
...
ent-ClothingUniformJumpskirtCapFormalDress = head of station's formal dress
