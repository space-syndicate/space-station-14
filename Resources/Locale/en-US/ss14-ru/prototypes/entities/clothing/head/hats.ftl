...
ent-ClothingHeadHatBeretQM = head of supply's beret
...
ent-ClothingHeadHatCaptain = head of station's hardhat
...
ent-ClothingHeadHatFez = fez
    .desc = A red fez.
ent-ClothingHeadHatHopcap = head of service's cap
...
ent-ClothingHeadHatBeretCmo = head of still just a week away's beret
...
ent-ClothingHeadHatCapcap = cap cap
    .desc = A grand, stylish head of station's cap.
