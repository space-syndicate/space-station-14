...
ban-banned-permanent = Этот бан можно только обжаловать, посетите наш Discord (ссылку можно найти по адресу https://discord.station14.ru).
ban-expires = Вы получили бан на { $duration } минут, и он истечёт { $time } UTC (для москосвкого времени добавьте 3 часа).
