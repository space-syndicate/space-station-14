...
instruments-component-menu-midi-source-button = MIDI Источник
...
instruments-component-menu-channels-label = Каналы [italic](обновляется при воспроизведении)[/italic]
