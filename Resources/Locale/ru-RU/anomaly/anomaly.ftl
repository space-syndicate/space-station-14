...
anomaly-scanner-particle-danger = - [color=crimson]Опасный вид:[/color] { $type }
anomaly-scanner-particle-unstable = - [color=plum]Настабильный вид:[/color] { $type }
anomaly-scanner-particle-containment = - [color=goldenrod]Сдерживающий вид:[/color] { $type }
