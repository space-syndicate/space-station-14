...
book-text-agrichemkit-manual =
    Спасибо, что выбрали безопасный для всех возрастов набор для химии NanoTrasen "АгроХимия это весело" - лучшую обучающую игрушку из 2468! Будьте готовы узнать всё о самых больших инновациях в сельском хозяйстве с тех пор, как люди закапывали рыбу вместе с семенами кукурузы.
    
    Содержание:
    5 удобно промаркированных бутылочек по 30ед, по 1 азота, фосфора, водорода, калия и этанола
    2 пробирки Безопасно-Весело(TM) размером 5ед , по 1 хлора и радия
    1 пустая бутылочка объёмом 30ед, готовая к проведению экспериментов.
    
    Первый эксперимент: EZ-нутриенты
    Чтобы создать EZ-нутриенты, удобрение, насыщенное питательными веществами, необходимыми для здоровых растений, смешайте равные доли азота, фосфора и калия. Чтобы сделать полную бутылочку, возьмите по 10ед каждого из них.
    Маленькая бутылочка EZ-нутриентов заменяет большую кучу продукции, которую в противном случае пришлось бы компостировать для поддержания сильного роста растений. А урожай, который вы компостируете, - это урожай, на котором вы не заработали, так что продолжайте использовать EZ-нутриенты.
    
    Второй эксперимент: Аммиак и диэтиламин
    Смешайте 3 доли водорода с 1 долей азота, чтобы получить аммиак. Это полезное и питательное лакомство для ваших культур, которые находятся не в лучшем состоянии.
    Но если вы хотите произвести впечатление на судей на местной окружной ярмарке, организованной компанией NanoTrasen, вам нужно добавить к аммиаку равное количество этанола.
    ...
    Когда вы будете готовы показать всем, что вы самый лучший ботаник на станции, вам нужно будет подмешать немного нестабильного мутагена и надеяться на лучшее. Несмотря на пугающее название, нестабильный мутаген совершенно безопасен при применении к растениям, но не пейте привлекательно-зелёный химикат лично.
    ...
    Нестабильный мутаген абсолютно безопасен при использовании в качестве удобрения, и NanoTrasen не несёт ответственности за погибшие посевы, чрезмерные счета за воду, новые разумные растения, задающие экзистенциальные вопросы, или за задушенные флорой руки фермеров, которые могут случайно возникнуть при его использовании.
