...
comms-console-menu-alert-level-button-tooltip = Изменение уровня оповещения станции. Применяется сразу после выбора.
comms-console-menu-call-shuttle = Вызвать
comms-console-menu-recall-shuttle = Отозвать
comms-console-menu-emergency-shuttle-button-tooltip = Вызывает или отзывает аварийный шаттл. Вы можете отозвать шаттл, только если осталось достаточно времени.
