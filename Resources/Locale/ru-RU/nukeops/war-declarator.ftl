...
war-declarator-boost-declared-delay = Война объявлена! Отправление шаттла временно недоступно
war-declarator-boost-timer = Оставшееся время: { $minutes } мин. и { $seconds } сек.
war-declarator-default-message = Пограничный отряд Синдиката объявил о своем намерении уничтожить станцию при помощи ядерного устройства и бросает вызов экипажу, пытающемуся их остановить.
war-declarator-message-placeholder = Введите сюда текст объявления войны...
