...
chem-master-window-sort-type-none = Сорт.: сначала старые
chem-master-window-sort-type-alphabetical = Сорт.: алфавит
chem-master-window-sort-type-quantity = Сорт.: кол-во
chem-master-window-sort-type-latest = Сорт.: сначала новые
