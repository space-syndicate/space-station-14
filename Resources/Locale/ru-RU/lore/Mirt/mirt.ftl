...
ent-MirtMagazineAutomat = Магазин к автомату "Развратник" 
    .suffix =  Миртан
ent-MirtPowerCell  = Батарея пожарного лазера "Месяц" 
    .suffix =  Миртан
...
ent-MirtCrateWeaponsNO = Ящик особого оружия Ноократии Эранта
    .suffix =  Миртан
...
ent-MirtCrateWeaponsEA = Ящик стандартной экипировки армии Империи Миртана
    .suffix =  Миртан
    .desc =  Пехотные элементы защиты и бронированной экипировки на 4 бойца.
...
ent-MirtCrateWeaponsNO = Ящик оснащения и вооружения Империи Миртана
    .suffix =  Миртан
