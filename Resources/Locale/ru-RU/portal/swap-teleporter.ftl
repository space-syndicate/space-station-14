...
swap-teleporter-examine-link-absent = [color=yellow]В настоящее время квантовая связь отсутствует.[/color] Используйте на другом устройстве чтобы установить квантовую связь.
