...
ui-options-audio-hrtf = Включить HRTF обработку звука (Требуется перезапуск)
...
ui-options-chat-follow-button = Как призрак, показывать кнопку наблюдения рядом с сообщениями чата
...
ui-options-disable-ai-static-tooltip = Заменятий эффект статического шума ИИ на простой градиент.
...
ui-options-disable-nv-noise-tooltip = Отключает эффект шума на наложении ночного видения.
ui-options-disable-rainbow-overlay = Радужное наложение
ui-options-disable-rainbow-overlay-tooltip = Заменяет движение в шейдере радужного наложения статическим смещением.
