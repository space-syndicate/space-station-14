...
ui-options-function-text-tab-complete = Автодополнение табуляцией
ui-options-function-text-complete-next = Следующее дополнение
ui-options-function-text-complete-prev = Предыдущее дополнение
...
ui-options-speech-bubble-text-opacity = Прозрачность текста в облачке
...
ui-options-overlay-ghost-fade-distance = Дистанция затухания оверлея призрака от курсора
