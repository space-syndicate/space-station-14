...
ui-options-max-fps-tooltip = Максимальная частота кадров, с которой должен работать клиент. Установите значение 0, чтобы ограничение отсутствовало. Это не имеет эффекта, если включена вертикальная синхронизация.
