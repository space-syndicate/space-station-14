...
ui-options-event-music = Музыка событий-эвентов
...
ui-options-function-activate-item-in-world = Использовать предмет на карте
ui-options-function-alt-activate-item-in-world = Альтернативно использовать предмет на карте
...
ui-options-function-focus-console-chat-window = Писать в чат (Console)
...
ui-options-function-open-tile-spawn-window = Открыть меню спавна плиток
