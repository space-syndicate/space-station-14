...
ent-CrateVendingMachineRestockRobustSoftdrinksFilled = ящик пополнения Прохладительные напитки Robust
...
ent-CrateVendingMachineRestockGetmoreChocolateCorpFilled = ящик пополнения Getmore Chocolate
...
ent-CrateVendingMachineRestockDonutFilled = ящик пополнения Monkin' Donuts
