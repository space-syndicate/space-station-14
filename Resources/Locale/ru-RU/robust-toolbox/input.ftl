...
input-key-NumpadAdd = Numpad Плюс
input-key-NumpadSubtract = Numpad Минус
input-key-NumpadDivide = Numpad Разделить
input-key-NumpadMultiply = Numpad Умножить
input-key-NumpadDecimal = Numpad Дробь
