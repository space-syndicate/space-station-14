...
cmd-loadgrid-desc = Загружает грид из файла на существующую картую.
...
cmd-rmgrid-desc = Удаляет грид с карты. Вы не можете удалить грид по умолчанию.
...
cmd-launchauth-desc = Загрузить токены аутентификации из данных средства запуска, чтобы облегчить тестирование работающих серверов.
...
cmd-hub_advertise_now-desc = Немедленно разместить объявление на главном хаб-сервере
