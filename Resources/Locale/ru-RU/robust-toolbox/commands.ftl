...
cmd-cvar-help = Использование: cvar <name | ?> [значение]
    Если значение пропущено, оно спарсится и сохранится как новое значение CVar.
...
cmd-gcf-help = Использование: gcf
    ...
    Скорее всего, это приведет к блокировке на сотни миллисекунд, имейте в виду.

## 'gc_mode' command
cmd-gc_mode-desc = Изменяет/считывает режим задержки GC
