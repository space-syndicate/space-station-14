...
cmd-gridtc-desc = Получает количество плиток в гриде.
...
cmd-uitest-desc = Откройте dummy UI окно для тестирования
cmd-uitest-help = Использование: uitest
cmd-uitest2-desc = Откройте UI контрольного тестирования ОС
...
cmd-togglehardfov-desc = Включает жёсткий fov для клиента. (для отладки space-station-14#2353)
...
cmd-cldbglyr-desc = Переключение слоёв отладки fov и освещения.
cmd-cldbglyr-help =
...
cmd-loc-desc = Выводит абсолютное местоположение сущности игрока на консоль.
cmd-loc-help = loc
cmd-tpgrid-desc = Телепортирует грид в новое место.
cmd-tpgrid-help = tpgrid <gridId> <X> <Y> [<MapId>]
cmd-rmgrid-desc = Удаляет грид с карты. Вы не можете удалить сетку по умолчанию.
...
cmd-lsgrid-desc = Перечисляет грид.
...
cmd-removeview-desc = Позволяет отписаться от подписки на просмотр сущности в целях отладки.
...
cmd-tpto-parse-error = Не удаётся разрешить сущность или игрока: { $str }
...
# Spin command
cmd-spin-desc = Заставляет сущность вращаться. Объект по умолчанию является надклассом прикреплённого игрока.
...
cmd-fuck-desc = Выдает исключение
cmd-fuck-help = Выдает исключение
cmd-showpos-desc = Включает отрисовку отладки для всех позиций сущностей в игре.
...
cmd-launchauth-desc = Загрузите токены аутентификации из данных средства запуска, чтобы облегчить тестирование работающих серверов.
...
cmd-physics-desc = Показывает наложение отладочной физики. Предоставленный arg определяет наложение.
...
cmd-hardquit-help = Убивает игровой клиент мгновенно, не оставляя следов. Не нужно прощаться с сервером.
...
cmd-net_watchent-desc = Выводит на консоль все сетевые обновления для EntityId.
...
cmd-vvread-desc = Получите значение пути с помощью VV (View Variables).
cmd-vvwrite-desc = Измените значение пути с помощью VV (View Variables).
...
cmd-hub_advertise_now-desc = Немедленное размещение рекламы на главном хаб-сервера
cmd-hub_advertise_now-help = Использование: hub_advertise_now
cmd-echo-desc = Возвращать аргументы в консоль
