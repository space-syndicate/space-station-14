...
reagent-desc-StrawberryIce = Особый наркотик, разработанный таким образом, чтобы быть еще сильнее, чем дезоксиэфедрин. Известный как «Клубничный лёд» или «Девичий лёд» из-за своего цвета и вкуса, он вызывает невероятную зависимость и сопровождается сильными симптомами абстиненции. Хотя эйфория от его употребления сильнее, и употребившие сообщают о полетах в радужных просторах космоса под его воздействием, тех, кто прекратит его употребление, ждут почти вечные ужасы.
