...
reagent-desc-tacitic-acid = Парализующее средство, воздействующее на гортань и лишающее пользователя возможности говорить. Из-за онемения, пострадавший не осознает происходящего, пока не попытается заговорить.
