...
reagent-desc-caipirinha = Спешл из Сан-Паулу, прямиком из старой Бразилии.
reagent-name-daiquiri = дайкири
reagent-desc-daiquiri = Классический коктейль на роме, популярный даже в холодных просторах космоса..
reagent-name-death-in-the-afternoon = смерть после полудня
reagent-desc-death-in-the-afternoon = "Налейте джиггер абсента в бокал для шампанского. Добавьте охлаждённое шампанское до появления опалесцирующей мутности. Выпейте три-пять таких - медленно." - Эрнест Хемингуэй
reagent-name-empress-75 = императрица 75
reagent-desc-empress-75 = Изысканный вариант мимозы. То, что могла бы потягивать Мария-Антуанетта перед революцией.
reagent-name-espresso-martini = эспрессо-мартини
reagent-desc-espresso-martini = Чтобы взбодриться и расслабиться одновременно. Подаётся холодным, с кофейными зёрнами.
reagent-name-mayojito = майохито
reagent-desc-mayojito = Оскорбление бога и человечества. Не пейте это.
reagent-name-mimeosa = миммоза
reagent-desc-mimeosa = Такой кислый апельсиновый вкус, что описать невозможно.
reagent-name-mimosa = мимоза
reagent-desc-mimosa = Идеально для шумного бранча с девчонками.
reagent-name-moscow-mule = московский мул
reagent-desc-moscow-mule = На удивление крепкий и освежающий микс, подаётся в культовой медной кружке.
reagent-name-the-sun-also-rises = и восходит солнце
reagent-desc-the-sun-also-rises = Крепкий коктейль, смешанный в мутный купаж. Секретный фаворит измученных писателей.
...
reagent-desc-bacchus-blessing = Не думали, что жидкость может быть настолько отвратительной. Вы уверены, что хотите это пить...?
