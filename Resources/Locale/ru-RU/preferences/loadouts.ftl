...
loadout-name-edit-label-dataset = Устанавливает настраиваемое имя, которое будет использоваться, если вы играете эту роль. Если поле пустое, вместо этого будет выбрано случайное имя.
