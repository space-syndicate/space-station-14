...
humanoid-profile-editor-preference-unavailable-stay-in-lobby-button = Остаться в лобби, если выбранная профессия недоступна.
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Стать {$overflowJob}, если выбранная профессия недоступна.
humanoid-profile-editor-preference-jumpsuit = Комбинезон
humanoid-profile-editor-preference-jumpskirt = Комби-юбка
...
humanoid-profile-editor-jobs-amount-in-department-tooltip = Работы в {$departmentName} департаменте
humanoid-profile-editor-department-jobs-label = {$departmentName} профессии
humanoid-profile-editor-antags-tab = Антагонизм
...
humanoid-profile-editor-naming-rules-warning = Внимание: Оскорбительные или ЛРП имена приведут к вмешательству администратора на этом сервере. Прочитайте \[Rules\], чтобы узнать подробнее.
