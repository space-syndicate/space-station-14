...
ghost-role-information-remilia-rules = Вы разумная летучая мышь-фруктоед. Следуйте за капелланом. Не создавайте никаких проблем, если только капеллан не скажет вам об этом.
...
ghost-role-information-cerberus-rules = Вы разумная, демоническая собака. Старайтесь помогать капеллану и любому из верных ему прихожан. Как антагонист, в остальном вы вольны делать что угодно.
