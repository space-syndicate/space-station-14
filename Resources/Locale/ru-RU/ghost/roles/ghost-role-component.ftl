...
ghost-role-information-centcom-official-description = Вы — обычный бумагомаратель, клерк на службе у корпорации. К вашему сожалению или к удовольствию — тут смотрите сами, офицер Центрального командования, как ваш непосредственный начальник, выдернул вас с рабочего места, переименовал карту и отправил на объект с инспекцией. Возможно проверять как уборщик ставит знаки мокрого пола, а может и разбираться с Командованием — только разбираться, ведь прямых командных полномочий у вас нет, но за точной целью обратитесь к администратору.
