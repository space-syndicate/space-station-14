...
guidebook-SOP-ChiefMedicalOfficer-must =
    ...
    1. Обеспечить комфортные условия для приёма пациентов в соответствии с техникой безопасности и процедурами медицинского отдела.
...
guidebook-SOP-ChiefMedicalOfficer-right =
    ...
    1. Выдавать разрешение на хранение и/или изготовление наркотических или токсических веществ для применения в медицинских целях.
      - Главный врач не имеет права выдавать разрешения на изготовление и использование критически опасных наркотиков, стимуляторов, биологического оружия и магических веществ.
