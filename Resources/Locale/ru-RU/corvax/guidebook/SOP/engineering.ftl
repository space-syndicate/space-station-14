...
guidebook-SOP-engineering-general-must =
    ...
    1. Обеспечить объект стабильным источником электропитания в кратчайшие возможные сроки.
    1. Обеспечить объект резервным источником электропитания.
    1. В случае, если при эвакуации с объекта не останется сотрудников, способных обслуживать генераторы, основанные на Сингулярности или Тесле, отключить их.
...
guidebook-SOP-ChiefEngineer-must =
    1. Удостовериться, что стабильный и резервный источники питания правильно подключены и настроены, перед тем как отдел будет предпринимать дальнейшие действия.
