...
guidebook-SOP-codes-green-terms =
    На станции отсутствует угроза безопасности — штатный режим работы.

guidebook-SOP-codes-green-norms =
    Экипаж действует в соответствии со стандартными рабочими процедурами.
...
guidebook-SOP-codes-blue-terms =
    На станции существует угроза безопасности I уровня.

guidebook-SOP-codes-blue-norms =
    Экипаж должен следовать указаниям службы безопасности и докладывать о подозрительной активности.
