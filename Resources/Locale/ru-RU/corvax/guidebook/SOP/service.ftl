...
guidebook-SOP-HeadOfPersonnel-must =
    ...
    1. Оказывать поддержку пассажирам и гостям станции:
    ...
    1. Изменять уровни доступов на законных основаниях.
      - Законными основаниями считаются:
        ...
        - заявление на получение доступа, заверенное печатью уполномоченного в их выдаче.
...
guidebook-SOP-HeadOfPersonnel-right =
    ...
    1. Представлять интересы пассажиров и гостей станции в качестве адвоката.
    ...
    1. Отлучаться по личным делам, оставляя табличку "Обед" на рабочем месте.
      - В случае вызова на рабочее место необходимо явиться в течение 5 минут.

guidebook-SOP-HeadOfPersonnel-prohibited =
    1. Вмешиваться в работу других отделов, если не приказано обратного.
      - В том числе посещать отделы станции, кроме Сервисного, без разрешения сотрудников соответствующего отдела.
        - В условиях ЧС или при прямой угрозе жизни разрешение не требуется.
