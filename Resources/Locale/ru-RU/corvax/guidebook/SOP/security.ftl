...
guidebook-SOP-security-general-prohibited =
    ...
    1. Посещать технические помещения в [color=green][bold]зелёный код[/bold][/color] без необходимости проведения следственных мероприятий.
