...
guidebook-SOP-Brigmedic-must =
    1. На постоянной основе находиться в пределах брига и лазарета Службы безопасности.
...
guidebook-SOP-Brigmedic-right =
    1. Проводить любые процедуры Службы безопасности в рамках, установленных процедурами, за исключением процедуры задержания.
      - Проведение процедуры задержания возможно в следующих случаях:
        - В условиях красного кода.
        - Если бриг-медик является свидетелем общественно опасного преступления.
...
-В рамках гамма кода, либо в условиях ЧС и отсутствии реакции ЦК в виде постановки кода, глава службы безопасности может одобрить использование любых запрещенных к обороту предметов
