...
guidebook-SOP-security-procedure-unregistered-protocol =
    ...
    1. В зависимости от результатов расследования капитан станции может принять следующие меры в отношении задержанного лица:
      - Если задержанное лицо является врагом корпорации, в отношении него может быть вынесена высшая мера наказания.
      ...
      - Если мотивы задержанного установить не удалось либо задержанный не заслуживает доверия, он должен содержаться в пермабриге для дальнейшей доставки на станцию ЦентКома. В отношении данного лица действуют правила содержания для заключенных пермабрига.
