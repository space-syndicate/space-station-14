...
guidebook-SOP-security-general-right =
    ...
    1. Оцепить место преступления с помощью щитов, голобарьеров,  маркеров улик и прочих инструментов Службы безопасности (исключая барьеры и стационарные вспышки) в целях проведения расследования.
      - Для создания оцепления необходимо одобрение ГСБ или капитана. Обязательно уведомление экипажа о создании оцепления в общий канал связи.
      - Район не может быть оцеплен более, чем на 5 минут и не может оцепляться повторно в рамках того же дела.
      - Пересечение оцепленной территории членами экипажа расценивается как помеха при проведении следственных мероприятий.

guidebook-SOP-security-general-prohibited =
    1. Проводить процедуры СБ и применять силу в отношении равных либо старших по иерархии сотрудников СБ, лиц с [tooltip="guidebook-SOP-security-tooltip-legal-immunity" text="юридической неприкосновенностью"] без приказа уполномоченного лица.
      ...
      - Исключением является проведение тренировочного мероприятия в специально отведенном месте в бриге, либо в пределах ринга.
...
guidebook-SOP-HeadOfSecurity-must =
    1. Координировать работу отдела Службы безопасности, обеспечивать поддержание порядка на станции и в ближайшем космическом пространстве.
      - Приоритет должен отдаваться вопросам, решение по которым может принять только ГСБ.
    ...
    1. Убедиться, что все сотрудники СБ имеют имплант «Щит разума», обеспечить его установку при отсутствии.
      - В случае отказа от установки принудительная имплантация строго запрещена, а сотрудник должен быть уволен.
      - Запрещается принятие сотрудников в отдел до установки импланта.
...
guidebook-SOP-HeadOfSecurity-right =
    ...
    1. В любой код держать при себе энергетический магнум/DT-12 "Законник" и/или энергетический меч «Правосудие».
      - Передача личного вооружения допускается иным сотрудникам СБ только в условиях ЧС.
...
guidebook-SOP-HeadOfSecurity-prohibited =
    ...
    1. Игнорировать законные запросы корпоративных агентов, включая запросы документов, требования корпоративного суда или иные.
...
guidebook-SOP-Warden-right =
    ...
    1. В любой код держать при себе личный энергетический дробовик и перчатки крав-мага.
      - В [color=dodgerblue][bold]синий код[/bold][/color] возможна передача этих предметов одному из сотрудников СБ на основании письменного разрешения.
        - В [color=red][bold]красный код[/bold][/color] и выше передача возможна с устного разрешения.
...
guidebook-SOP-Detective-must =
    ...
    1. Оказывать содействие офицерам СБ в поддержании порядка на станции.
...
guidebook-SOP-Brigmedic-must =
    1. На постоянной основе находиться в пределах брига или лазарета Службы безопасности.
      - Допускается покинуть бриг на короткий срок с разрешения смотрителя или ГСБ 
...
guidebook-SOP-Brigmedic-right =
    1. Проводить любые процедуры Службы безопасности в рамках, установленных процедурами, за исключением процедуры задержания.
      - Проведение процедуры задержания возможно в следующих случаях:
        - В условиях [color=red][bold]красного кода[/bold][/color].
        - Если бригмедик является свидетелем [tooltip="guidebook-SOP-security-tooltip-public-dangerous-crime" text="общественно опасного преступления"].
        - В отношении лиц в розыске или доставленных для лечения заключенных и подозреваемых.
...
guidebook-SOP-security-procedure-weapons-regulation =
    1. Глава службы безопасности и смотритель заведуют арсеналом: выдавать и принимать вооружение в соответствии с уровнем угроз.
      - По усмотрению главы службы безопасности или смотрителя может быть заказано дополнительное оружие в отделе Снабжения или в Научном отделе и доставлено в арсенал.
    ...
    1. В штатном режиме сотрудники Службы безопасности могут владеть оружием только в соответствии с таблицей стандартного вооружения или особыми разрешениями в личных СРП.
      ...
      - Допускается ношение MOD на постоянной основе, однако открытое применение бронированных элементов допускается только в условиях [color=dodgerblue][bold]синего код[/bold][/color] или выше, а также в условиях экстремального давления.
      ...
      - Глава службы безопасности имеет право держать при себе личный энергетический магнум/DT-12 "Законник" и/или личный энергетический меч.
      - Корабельные орудия доступны для установки только на шаттлах Службы безопасности. Исключением является дематерилизатор материи как рабочее оборудование утилизаторов.
...
guidebook-SOP-security-weapons-tooltip-reinforced = Включает в себя любую неконтрабандную броню, за исключением скафандров, тяжёлых бронекостюмов.
...
guidebook-SOP-security-procedure-investigation-interrogation =
    ...
    1. В процедуре допроса принимают участие задержанный, допрашивающий, а также адвокат, свидетели и эксперты, если таковые имеются.
      ...
      - При допросе главы отдела обязательным условием должно быть присутствие агента внутренних дел, представителя NT, либо капитана.
...
guidebook-SOP-security-procedure-seizure-turnover =
    ...
    1. Предметы, регулируемые статьями 435 и 436 подлежат хранению в запираемом шкафу. Его оборот и использование без надлежащего разрешения строго запрещены.
      ...
      - В рамках [color=gold][bold]гамма кода[/bold][/color], либо в условиях ЧС при отсутствии ответа от ЦК на запрос [color=gold][bold]гамма кода[/bold][/color], глава службы безопасности может одобрить использование любых запрещенных к обороту предметов.
...
guidebook-SOP-security-procedure-force-level-4 =
    ...
    1. С целью подавления транспортного средства, включая сегвеи и их аналоги, а также шаттлы. Целью должно быть устранение мобильности, после чего уровень силы необходимо понизить до актуального.
