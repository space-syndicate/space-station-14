...
guidebook-SOP-command-general-must =
    ...
    1. Поддерживать датчики на комбинезоне в режиме «Координаты», а также пройти сканирование от ОСЩ, в случае если таковой присутствует на станции.
      - Данный пункт утрачивает актуальность в случае захвата станции противником.
