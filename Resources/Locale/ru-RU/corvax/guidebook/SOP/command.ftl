...
guidebook-SOP-command-procedure-appoint-acting-captain =
    ...
    2. Пост капитана  обязан принять следующий по цепи сотрудник:
    ...
    3. В [color=red][bold]красный код и выше[/bold][/color] глава службы безопасности имеет право принять руководство станцией на себя, сместив текущего ВрИО капитана до снижения кода.
    ...
    4. Центральное командование должно быть уведомлено о назначении ВрИО капитана соответствующим заявлением в течение 10 минут после назначения.
    5. ВрИО капитана не получает юридическую неприкосновенность.
