...
guidebook-SOP-command-procedure-accesses =
    ...
    1. Назначение на должности Юридического Департамента, Центрального Командования, Департамента Специальных Операций возможно только по письменному приказу уполномоченного лица соответствующего ведомства.
