...
guidebook-SOP-Quartermaster-right =
    ...
    1. Выбирать приоритетный вид работ для утилизаторов и шахтеров.
    ...
    1. Посещать аванпост Лаваленда с целью координации шахтеров.
      - Не допускается покидать границы шахтерского аванпоста. Срок пребывания ограничивается 5 минутами не чаще, чем раз в 15 минут.
      - Перед отбытием на Лаваленд КМ обязан оставить временного заместителя из числа грузчиков.
      - В случае невыхода группы шахтеров на связь рекомендуется организация спасательной группы силами СБ и медицинского отдела. Личное участие не допускается.

guidebook-SOP-Quartermaster-prohibited =
    1. Выполнять утилизационные и шахтерские работы любого типа и участвовать в экспедициях.
    1. Посещать Лаваленд и допускать туда персонал станции вне дозволений.
