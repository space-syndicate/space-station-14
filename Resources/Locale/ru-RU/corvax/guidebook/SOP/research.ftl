...
guidebook-SOP-Roboticist-must =
    ...
    2. Собирать, обслуживать и модернизировать экзоскелеты и роботизированное оборудование.
    ...
    3. Осуществлять обслуживание корпусов К.П.Б.
      - Необоснованный отказ в ремонте корпуса К.П.Б. приравнивается к нарушению статьи 112 Корпоративного Закона.
