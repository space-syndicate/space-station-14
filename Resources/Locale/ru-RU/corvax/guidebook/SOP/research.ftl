...
guidebook-SOP-ResearchDirector-must =
    ...
    1. Контролировать исправность работы боргов.
      - В случае подтверждённого нарушения или несанкционированного изменения законов борг должен быть признан сбойным.
      - Научный руководитель обязан проконтролировать то, чтобы оболочка сбойного борга была утилизирована, а его позитронный мозг или мозго-машинный интерфейс были пересажены в другую.
      - Если изменение законов произошло в результате ионного шторма, научный руководитель имеет право оставить новые законы и не утилизировать борга, если они не противоречат стандартному своду законов Крюзимов и не препятствуют эффективной работе юнита.
...
guidebook-SOP-Scientist-must =
    ...
    1. Осуществлять техническое обслуживание боргов и оснащать их необходимыми для корректной работы модулями, если в отделе имеются все нужные для этого технологии и материалы.
...
guidebook-SOP-Roboticist-must =
    1. Собирать, обслуживать и модернизировать боргов, дронов и ботов.
      - Производить сборку новых боргов, дронов и ботов по собственному желанию или по письменному запросу.
      - Робототехник имеет право отказать в сборке при отсутствии необходимых ресурсов или материалов.
      - Обслуживание и ремонт вражеских или сбойных боргов, дронов и ботов не осуществляется.
