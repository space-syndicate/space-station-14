...
guidebook-SOP-ResearchDirector-must =
    ...
    1. Контролировать исправность работы киборгов.
      ...
      - Если изменение законов произошло в результате ионного шторма, научный руководитель имеет право оставить новые законы, если они не противоречат интересам станции, не создают угрозы безопасности и не препятствуют эффективной работе юнита.
    1. Следить, чтобы исследования велись в приемлемом темпе и отдел не простаивал.
      - Не допускается игнорирование исследовательских запросов глав иных отделов при отсутствии объективных причин.
    1. Следить, чтобы [tooltip="guidebook-SOP-research-tooltip-dangerous-equipment" text="опасное снаряжение"], [tooltip="guidebook-SOP-research-tooltip-dangerous-substances" text="опасные вещества"], исследовательские материалы и артефакты не покидали территорию научного отдела без законного основания.
...
guidebook-SOP-ResearchDirector-right =
    ...
    1. Издавать письменные приказы о признании разумности существ, наделяя их К-ОПРС.
    1. Использовать электронного двойника как личного ассистента в любое время.
...
guidebook-SOP-ResearchDirector-prohibited =
    ...
    1. Игнорировать запросы и уведомления о проявившихся на станции артефактах и аномалиях, либо иных событиях, попадающих в зону интересов отдела.
