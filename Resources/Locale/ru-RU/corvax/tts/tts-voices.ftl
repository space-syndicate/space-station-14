...
tts-voice-name-byasha = Byasha (Tiny Bunny)
tts-voice-name-cerys = Cerys (Witcher)
tts-voice-name-philippa = Philippa (Witcher)
tts-voice-name-oldnekro = Oldnekro (Evil Islands)
tts-voice-name-lambert = Lambert (Witcher)
tts-voice-name-shani = Shani (Witcher)
tts-voice-name-anton = Anton (Tiny Bunny)
tts-voice-name-dolg1 = Dolg1 (STALKER)
tts-voice-name-guru = Guru (Evil Islands)
tts-voice-name-lugos = Lugos (Witcher)
tts-voice-name-karina = Karina (Tiny Bunny)
tts-voice-name-ewald = Ewald (Witcher)
tts-voice-name-mirror = Mirror (Witcher)
tts-voice-name-noble = Noble (Witcher)
tts-voice-name-huber = Huber (Evil Islands)
tts-voice-name-wywern = Wywern (Dota 2)
tts-voice-name-avallach = Avallach (Witcher)
tts-voice-name-semen = Semen (Tiny Bunny)
tts-voice-name-all_elder = All_elder (Evil Islands)
tts-voice-name-nsheriff = Nsheriff (Evil Islands)
tts-voice-name-orcc = Orcc (Evil Islands)
tts-voice-name-clerk = Clerk (Evil Islands)
tts-voice-name-witch = Witch (Evil Islands)
tts-voice-name-deva = Deva (Evil Islands)
tts-voice-name-coach = Coach (Left 4 Dead)
tts-voice-name-dictor = Dictor (Portal 2)
tts-voice-name-monolith2 = Monolith2 (STALKER)
tts-voice-name-invoker = Invoker (Dota 2)
tts-voice-name-goblin = Goblin (Evil Islands)
tts-voice-name-annah = Annah (Witcher)
tts-voice-name-patrick = Patrick (SpongeBob)
tts-voice-name-spongebob = Spongebob (SpongeBob)
tts-voice-name-kapitan = Kapitan (Evil Islands)
tts-voice-name-karh = Karh (Evil Islands)
tts-voice-name-lydia_tb = Lydia_tb (Tiny Bunny)
tts-voice-name-silencer = Silencer (Dota 2)
tts-voice-name-sheriff = Sheriff (Evil Islands)
tts-voice-name-lycan = Lycan (Dota 2)
tts-voice-name-cirilla = Cirilla (Witcher)
tts-voice-name-legends = Legends (STALKER)
tts-voice-name-monolith1 = Monolith1 (STALKER)
tts-voice-name-trapper = Trapper (Evil Islands)
tts-voice-name-mirana = Mirana (Dota 2)
tts-voice-name-glav = Glav (Evil Islands)
tts-voice-name-syanna = Syanna (Witcher)
tts-voice-name-regis = Regis (Witcher)
tts-voice-name-dazzle = Dazzle (Dota 2)
tts-voice-name-mthief = Mthief (Evil Islands)
tts-voice-name-guillaume = Guillaume (Witcher)
tts-voice-name-vivienne = Vivienne (Witcher)
tts-voice-name-plankton = Plankton (SpongeBob)
tts-voice-name-rochelle = Rochelle (Left 4 Dead)
tts-voice-name-vor = Vor (Evil Islands)
tts-voice-name-grandmother = Grandmother (Tiny Bunny)
tts-voice-name-dolg2 = Dolg2 (STALKER)
tts-voice-name-junboy = Junboy (Evil Islands)
tts-voice-name-shopper = Shopper (Evil Islands)
tts-voice-name-papillon = Papillon (Witcher)
tts-voice-name-cm = Cm (Dota 2)
tts-voice-name-vesemir = Vesemir (Witcher)
tts-voice-name-kate = Kate (Tiny Bunny)
tts-voice-name-polina = Polina (Tiny Bunny)
tts-voice-name-crach = Crach (Witcher)
tts-voice-name-gryphon = Gryphon (WarCraft 3)
tts-voice-name-zeus = Zeus (Dota 2)
tts-voice-name-iz = Iz (Evil Islands)
tts-voice-name-geralt = Geralt (Witcher)
tts-voice-name-stories = Stories (STALKER)
tts-voice-name-nekro = Nekro (Evil Islands)
tts-voice-name-hwleader = Hwleader (Evil Islands)
tts-voice-name-yennefer = Yennefer (Witcher)
tts-voice-name-hero = Hero (Evil Islands)
tts-voice-name-baratrum = Baratrum (Dota 2)
tts-voice-name-ellis = Ellis (Left 4 Dead)
tts-voice-name-udalryk = Udalryk (Witcher)
tts-voice-name-dad = Dad (Tiny Bunny)
tts-voice-name-smith = Smith (Evil Islands)
tts-voice-name-romka = Romka (Tiny Bunny)
tts-voice-name-abaddon = Abaddon (Dota 2)
tts-voice-name-eskel = Eskel (Witcher)
tts-voice-name-freedom = Freedom (STALKER)
tts-voice-name-magess = Magess (Evil Islands)
tts-voice-name-nalo = Nalo (Evil Islands)
tts-voice-name-dandelion = Dandelion (Witcher)
tts-voice-name-palmerin = Palmerin (Witcher)
tts-voice-name-olgierd = Olgierd (Witcher)
tts-voice-name-d_sven = D_sven (Dota 2)
tts-voice-name-triss = Triss (Witcher)
tts-voice-name-monkey = Monkey (Dota 2)
tts-voice-name-squidward = Squidward (SpongeBob)
tts-voice-name-ember = Ember (Dota 2)
tts-voice-name-ycf = Ycf (Evil Islands)
tts-voice-name-nick = Nick (Left 4 Dead)
tts-voice-name-hjalmar = Hjalmar (Witcher)
