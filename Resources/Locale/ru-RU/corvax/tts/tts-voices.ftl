...
tts-voice-name-vanndara = Вандар Грозовая Вершина (Heroes of the Storm)
...
tts-voice-name-sinclari = Лейтенант Синклари (Hearthstone)
...
tts-voice-name-tekahnboss = Текан, Кара Огненная (Hearthstone)
tts-voice-name-siamat = Сиамат (Hearthstone)
tts-voice-name-omnotron = Омнитрон (Hearthstone)
tts-voice-name-putricide = Профессор Мерзоцид (Hearthstone)
...
tts-voice-name-deathwhisper = Смертный Шепот (Hearthstone)
