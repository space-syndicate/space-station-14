...
tts-voice-name-all_elder = All Elder (Evil Islands) //послушать уточнить
tts-voice-name-nsheriff = Шериф Н (Проклятые земли)
tts-voice-name-orcc = Орк К (Проклятые земли)
...
tts-voice-name-sheriff = Шериф Ф (Проклятые земли)
