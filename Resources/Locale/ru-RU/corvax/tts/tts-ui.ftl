...
ui-options-tts-radio-filter = Фильтр радио-каналов TTS
ui-options-tts-radio-filter-description = Выберите радиоканалы, которые вы хотите озвучить с помощью TTS.
