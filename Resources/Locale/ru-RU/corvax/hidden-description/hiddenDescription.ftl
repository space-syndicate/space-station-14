...
corvax-hidden-desc-Chameleon-thief = [color=#1c9c51]Этот предмет оснащен очень ценной технологией маскировки.[/color]
...
corvax-hidden-desc-VoiceMasker-research = [color=#D381C9]Имеет функцию преобразователя голоса.[/color]

corvax-hidden-desc-NoSlip-ninja = [color=#14e397]Обувь магнитной основы. Упасть не даст на колени, перед лицом врага.[/color]
...
corvax-hidden-desc-UplinkImplanter-syndicate = [color=#e31735]Это имплантер черного рынка. Позволит пользоваться спрятанным аплинком Синдиката, даже если у меня все заберут.[/color]
...
corvax-hidden-desc-BibleNecronomicon-service = [color=#9FED58]Этот древний фолиант пропитан проклятой энергией, и однозначно не принесет ничего хорошего. От него веет злобой.[/color]

corvax-hidden-desc-Telecrystal-syndicate = [color=#e31735]Валюта черного рынка синдиката. Позволяет покупать через редспейс пространство посредством аплинка различное нелегальное вооружение.[/color]
