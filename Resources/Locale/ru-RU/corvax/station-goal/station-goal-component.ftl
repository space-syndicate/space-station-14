...
station-goal-mining-outpost =
    Цель вашей смены постройка орбитального шахтерского аванпоста для добычи руды и ресурсов с обломков.
    Он должен быть размещен в космосе отдельно от основной станции.
    Проследите за прочностью его конструкции, случайный метеорит не должен разрушить его.
    Аванпост должен оборудоваться следующим образом:
    - автономный, бесперебойный источник электроэнергии
    - генератор гравитации
    - оборудование для его функционирования, в частности магнит для обломков
    - комнаты для проживания 2 человек, с атмосферой, освещением и окнами
    - склад для добытых ресурсов, пищи и медикаментов
...
station-goal-containment =
    ...
    Проследите за прочностью ее конструкции, оно не должно легко сбежать.
    Камера должна быть размещена на окраине станции во избежание жертв.
    Она должна иметь окна и шлюзы с уровнем доступа, как минимум, научного руководителя.
    Примерный план, начиная от центра:
    - помещение 3 на 3, с покрытием
    - двойные стены
    - космические вакуум
    - двойные стены
    Проследите за сохранностью камеры до окончания смены.
