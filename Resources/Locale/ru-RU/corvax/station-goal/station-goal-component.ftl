...
station-goal-singularity =
    { station-goal-start }
    Цель смены станции { $station } — постройка генератора, основанного на сингулярности.
...
station-goal-solar-panels =
    { station-goal-start }
    Цель смены станции { $station } — постройка сети солнечных панелей.
...
station-goal-artifacts =
    { station-goal-start }
    Цель смены станции { $station } — нахождение и исследование артефактов.
...
station-goal-zoo =
    { station-goal-start }
    Цель смены станции { $station } — улучшение рекреации персонала станции. 
...
station-goal-mining-outpost =
    { station-goal-start }
    Цель смены станции { $station } — постройка орбитального шахтёрского аванпоста. 
...
station-goal-tesla =
    { station-goal-start }
    Цель смены станции { $station } — постройка генератора, основанного на тесле.
...
station-goal-security =
    { station-goal-start }
    Цель смены станции { $station } — постройка и снабжение тренировочного комплекса для Службы Безопасности, с последующей проверкой состава.
...
station-goal-shuttle-med =
    { station-goal-start }
    Цель смены станции { $station } — постройка пилотируемого медицинского шаттла.
    ...
    3. К имеющемуся на шаттле оборудованию и отсекам должен быть свободный доступ к использования у потенциального экипажа данного шаттла.
...
station-goal-shuttle-sec =
    { station-goal-start }
    Цель смены станции { $station } — постройка пилотируемого десантного шаттла.
...
station-goal-shuttle-rnd =
    { station-goal-start }
    Цель смены станции { $station } — постройка пилотируемого исследовательского шаттла.
...
station-goal-shuttle-srv =
    { station-goal-start }
    Цель смены станции { $station } — постройка пилотируемого пассажирского шаттла.
...
station-goal-shuttle-emergency =
    { station-goal-start }
    Цель смены станции { $station } — постройка пилотируемого спасательного шаттла.
...
station-goal-theatre =
    { station-goal-start }
    Цель смены станции { $station } — постройка театральной зоны.
    На данной станции будут проведены переговоры с крупными компаниями для заключения партнерства. Необходимо позаботиться о гостеприимном приёме.
    
    Театральная зона должна включать в себя:
    1. Сцена минимальным размером в 28м².  
    2. Минимальная вместимость зала в 21 существ, включая отдельные места оборудованные для расы Вокс.
...
station-goal-ai =
    { station-goal-start }
    Цель смены станции { $station } — постройка автономного отсека ИИ.
...
station-goal-botany =
    { station-goal-start }
    Цель смены станции { $station } — постройка теплиц и выведение приспособленных к температуре растений.
...
station-goal-bunker =
    { station-goal-start }
    Цель смены станции { $station } — приспособить станцию к мощным гиперэнергетическим потокам.
...
station-goal-frame-repair =
    { station-goal-start }
    Цель смены станции { $station } — окончание строительных работ на станции.
...
station-goal-delta-xeno-repair =
    { station-goal-start }
    Цель смены станции { $station } — восстановление заброшенного ксенобиологического сектора научного отдела.
...
station-goal-delta-ambusol =
    { station-goal-start }
    Цель смены станции { $station } — восстановление заброшенного вирусологического сектора медицинского отдела.
...
station-goal-split-secure =
    { station-goal-start }
    Цель смены станции { $station } — обеспечить безопасность в субсекторе Split.
...
station-goal-astra-repair =
    { station-goal-start }
    Цель смены станции { $station } — восстановление заброшенной части космической станции, находящейся в центральной части.
    
    Вам необходимо избавиться от мешающей проведению работ враждебной фауны и восстановить электропитание, атмосферу, привести внешний вид к изначальному состоянию. Также следует выставить на шлюзах необходимые доступы отделов и обеспечить свободное посещение сотрудниками станции зоопарка и музея. По воможности следует сохранить образцы фауны в зоопарке.
