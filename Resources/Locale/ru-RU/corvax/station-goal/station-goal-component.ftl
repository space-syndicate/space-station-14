...
station-goal-zoo =
    ...
    А именно построить инженерному отделу зоопарк в недалекой доступности от дорматориев как минимум c тремя вольерами животных разных видов заказанных в отделе снабжения.
    Обеспечьте животных пищей, как минимум одним роботом уборщиком на вольер и всем необходимым для жизни в зависимости от вида.
