...
station-goal-start = [color=#b8972d]███[/color][color=#1d7a1d]░███░░░░██░░░░[/color][color=#b8972d]                          ★ ★ ★[/color][color=#1d7a1d]
    ...
    Вы также можете закончить смену досрочно выполнив второстепенную задачу по [bold]желанию экипажа[/bold].
    
    При выполнении первоспепенной [bold]или[/bold] второстепенной цели вы получите полный оклад, но лишитесь премиальных.
