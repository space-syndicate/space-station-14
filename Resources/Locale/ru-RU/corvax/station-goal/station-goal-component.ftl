...
station-goal-intelligent-animals =
    Цель вашей смены сделать разумными 5 животных.
    Для её выполнения требуется найти карпов, вырастить другие ингридиенты, приготовить из них когнизин и дать его выбранным животным, которые были предварительно найдены или заказаны. Каждое разумное животное должно получить собственное помещение, пригодное для их проживания, размером не менее 2x3 с местом для сна и запасом еды и воды, находящегося неподалёку.
    По завершению смены эвакуировать животных в целости и сохранности на ЦК.
