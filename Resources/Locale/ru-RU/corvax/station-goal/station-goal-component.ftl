...
station-goal-bunker =
    ...
    Необходимо пристроить по комнате, далее именуемой как “бункер”, следующим отделам: Службы Безопасности, Мединискому и Командному. В них экипаж станции мог бы укрыться от последствий гиперэнергетических потоков.
