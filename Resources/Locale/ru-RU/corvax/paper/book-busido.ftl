...
book-text-busido =
    ...
    Он будет исключительной личностью, наделенной прекрасными качествами. Ибо жизнь мимолётна, подобно капле вечерней росы и утреннему инею, и тем более такова жизнь воина.
    ...
    Ибо если самурай идёт в битву, совершает отважные и величественные поступки и покрывает славой свое имя, то это только потому, что он настроил свое сердце на смерть.
