...
book-text-busido =
    ...
    с того утра, когда он берет в руки палочки, чтобы вкусить новогоднюю трапезу, до последней ночи старого года, когда он платит свои долги — что он должен умереть. Вот его главное дело.
    ...
    Он будет исключительной личностью, наделенной прекрасными качествами. Ибо жизнь мимолетна, подобно капле вечерней росы и утреннему инею, и тем более такова жизнь воина.
    ...
    Как бы ни был он умен и талантлив, если он беспечен и недостаточно хладнокровен, а потому, оказавшись лицом к лицу со смертью, выглядит растерянным, все его предыдущие добрые дела потеряют свой смысл, а все порядочные люди будут презирать его, и на него ляжет несмываемое пятно позора.
    
    Ибо если самурай идет в битву, совершает отважные и величественные поступки и покрывает славой свое имя, то это только потому, что он настроил свое сердце на смерть.
    Если случается худшее, и ему суждено расстаться с жизнью, то, когда его противник спрашивает его имя, он должен громко и четко ответить и проститься с жизнью с улыбкой на губах, не выказывая ни малейшего признака страха. 
    
    Если же он тяжело ранен, так, что ни один лекарь уже не может помочь ему, то, как и положено самураю, он должен, будучи еще в сознании, ответить на вопросы командиров и товарищей и сообщить им, как он получил ранение, после чего спокойно, без всяких церемоний, встретить смерть.
