...
cmd-dungen_preset_vis-desc = Генерирует основанное на тайлах превью пресета подземелья.
cmd-dungen_preset_vis-help = dungen_preset_vis <mapid> <preset>
cmd-dungen_pack_vis-success = Успешно
cmd-dungen_pack_vis-desc = Генерирует основанное на тайлах превью группы подземелий.
