...
ent-FloorTileItemWoodChessRed = красный деревянный шахматный пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemAstroConcrete = бетонный астро-пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemAstroConcreteMono = бетонная астро-плитка
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemAstroGrayConcrete = серый бетонный астро-пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemAstroGrayConcreteMono = серая бетонная астро-плитка
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemAstroOldConcrete = старый бетонный астро-пол
    .desc = { ent-FloorTileItemBase.desc }
ent-FloorTileItemAstroOldConcreteMono = старая бетонная астро-плитка
    .desc = { ent-FloorTileItemBase.desc }
