ent-CrateEmergencyExplosive = ящик сапёрного снаряжения
    .desc = Учёные обезумели? Что-то пищит за шлюзом? Купите сейчас и станьте героем, которого станция засл... Я имею в виду, в котором нуждается! (время в комплект не входит).
...
ent-CrateGenericBiosuit = ящик аварийных биозащитных костюмов
    .desc = Содержит 2 костюма биологической защиты, чтобы никакая зараза не отвлекала вас от ваших дел.
