...
ent-CrateFunInstrumentsSpecial = набор специальных коллекционных инструментов
    .desc = Поднимите шум при помощи этой специальной коллекции почти-инструментов! Корпорация не несёт ответственности за любые травмы, вызванные содержимым ящика.
ent-CrateFunInstrumentsRandom = коллекция случайных инструментов
    .desc = Ящик, содержащий несколько случайных инструментов, отобранных лучшими музыкантами корпорации!
