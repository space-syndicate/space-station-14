...
ent-CrateFunFoamGuns = ящик оружия Сила Пенопласта
    .desc = Содержит четыре винтовки Сила Пенопласта, несколько гранат и запасные патроны. Либо [УДАЛЕНО], либо ничего!
