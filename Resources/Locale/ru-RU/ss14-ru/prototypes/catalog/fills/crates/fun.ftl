...
ent-CrateFunInstruments = коллекция музыкальных инструментов
    ...
    .suffix = { "" }
ent-CrateFunBrass = ящик инструментов духового ансамбля
    .desc = Добавьте джаза в жизнь станции с набором духовых инструментов. Содержит разнообразные духовые инструменты, на которых может играть вся станция.
    .suffix = { "" }
