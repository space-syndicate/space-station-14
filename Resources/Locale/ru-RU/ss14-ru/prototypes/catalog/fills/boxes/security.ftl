...
ent-BoxFlashbang = Коробка светошумовых гранат
    ...
    .suffix = { "" }
ent-BoxSechud = коробка sechud
    .desc = Коробка очков, используемых службой безопасности.
    .suffix = { "" }
ent-BoxZiptie = коробка стяжек
    .desc = Полная коробка кабельных стяжек.
    .suffix = { "" }
ent-BoxBeanbag = коробка травматических патронов
    .desc = Полная коробка травматических ружейных патронов, для борьбы с беспорядками.
    .suffix = { "" }
ent-BoxLethalshot = коробка боевых патронов
    .desc = Полная коробка боевых ружейных патронов, для борьбы с беспорядками.
    .suffix = { "" }
