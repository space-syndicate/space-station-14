ent-BoxSyringe = коробка шприцов
    ...
    .suffix = { "" }
ent-BoxPillCanister = коробка таблетниц
    .desc = Полная коробка таблетниц.
    .suffix = { "" }
ent-BoxBottle = коробка пузырьков
    .desc = Полная коробка пузырьков.
    .suffix = { "" }
...
ent-BoxNitrileGloves = коробка нитриловых перчаток
    ...
    .suffix = { "" }
ent-BoxMouthSwab = коробка ватных палочек
