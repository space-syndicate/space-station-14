...
ent-MobMonkey = обезьяна
    ...
    .suffix = { "" }
ent-MobGuidebookMonkey = учебная обезьяна
    .desc = Возможно полезная обезьяна, чья единственная цель в жизни - чтобы вы кликнули на неё. Можно ли считать, что обезьяна преподала вам урок?
    .suffix = { "" }
ent-MobMouse = мышь
    .desc = Пии!
    .suffix = { "" }
