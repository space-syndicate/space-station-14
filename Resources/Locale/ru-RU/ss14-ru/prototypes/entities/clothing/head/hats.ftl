...
ent-ClothingHeadPyjamaSyndicateBlack = чёрная пижамная шапочка Синдиката
    .desc = Чтобы держать твою предательскую голову в тепле.
ent-ClothingHeadPyjamaSyndicatePink = розовая пижамная шапочка Синдиката
    .desc = Чтобы держать твою предательскую голову в тепле.
ent-ClothingHeadPyjamaSyndicateRed = красная пижамная шапочка Синдиката
    .desc = Чтобы держать твою предательскую голову в тепле.
...
ent-ClothingHeadWehcellentCap = вехиколепная кепка
    .desc = Это же сетчатая кепка! Превехсходная вещь для ассистентов! Сзади есть отверстия для проветривания и всякое такое!
