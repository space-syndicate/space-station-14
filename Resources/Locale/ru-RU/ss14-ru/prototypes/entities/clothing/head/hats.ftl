...
ent-ClothingHeadHatBeretNavyBlue = Синий берет офицера "Синий Щит"
    .desc = Темно-синий берет, украшенный щитом - серебряным змеиным щитом с выгравированным мечом сил безопасности Нано-Трэйзена, объявляющим миру, что его владелец является защитником Нано-Трэйзена.
