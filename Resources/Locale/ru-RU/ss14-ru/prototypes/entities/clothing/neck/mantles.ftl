...
ent-ClothingNeckMantleCMO = мантия главного врача
    .desc = Для ГВ, который побывал в достаточном количестве медбеев, чтобы знать, что чем больше больше СИЗ, тем меньше визитов в хим чистку после окончания смены.
