...
ent-ClothingOuterCoatSyndieCap = тренч Синдиката
    .desc = Пальто Синдиката, изготовлено из прочной ткани, украшено позолоченными узорами.
ent-ClothingOuterCoatSyndieCapArmored = бронированный тренч Синдиката
    .desc = Бронированное пальто Синдиката, изготовлено из прочной ткани, украшено позолоченными узорами.
