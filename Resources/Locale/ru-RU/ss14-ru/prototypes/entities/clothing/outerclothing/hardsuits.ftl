...
ent-ClothingOuterHardsuitLuxury = элитный шахтёрский скафандр
    .desc = Отремонтированный шахтерский скафандр, выполненный в цветах квартирмейстера. Графеновая подкладка имеет меньше защиты, но в нем гораздо легче перемещаться.
