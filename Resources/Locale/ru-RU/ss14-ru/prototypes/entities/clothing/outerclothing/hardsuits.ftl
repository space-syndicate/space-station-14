...
ent-ClothingOuterHardsuitLuxury = элитный шахтёрский скафандр
    .desc = Отремонтированный шахтёрский скафандр, выполненный в цветах квартирмейстера. Графеновая подкладка имеет меньше защиты, но в нем гораздо легче перемещаться.
