ent-ClothingOuterArmorReflective = светоотражающий жилет
    .desc = Усиленный жилет с усовершенствованной защитой от энергетического оружия.
    .suffix = { "" }
ent-ClothingOuterArmorBulletproof = пуленепробиваемый жилет
    .desc = Усиленный жилет с тяжелыми пластинами для защиты от баллистических снарядов.
    .suffix = { "" }
