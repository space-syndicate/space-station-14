...
ent-ClothingUniformJumpsuitCentcomOfficial = костюм офицера Центком
    .desc = Это костюм, который носят офицеры Центком высшего звена.
...
ent-ClothingUniformJumpsuitPrisoner = комбинезон заключённого
    .desc = Комбинезон, предназначенный для заключённых. Датчики костюма автоматически включены, без возможности смены режима.
