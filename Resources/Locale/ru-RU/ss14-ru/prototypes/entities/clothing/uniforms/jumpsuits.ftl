...
ent-ClothingUniformJumpsuitVirology = комбинезон вирусолога
    ...
    .suffix = { "" }
ent-ClothingUniformJumpsuitGenetics = комбинезон гинетика
    .desc = Он сделан из специального волокна, которое обеспечивает особую защиту от биологических опасностей. На нем есть нашивка с рангом генетика.
    .suffix = { "" }
