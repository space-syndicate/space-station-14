...
ent-ClothingUniformJumpsuitTacticool = тактический комбизенон
    .desc = Униформа для оперативных LARPеров, выполняющих тактические кражи утепленных перчаток в глубоком космосе.
