...
ent-ClothingUniformJumpskirtHosFormal = торжественное платье главы службы безопасности
    .desc = Платье для особых случаев.
    .suffix = { "" }
ent-ClothingUniformJumpskirtOperative = юбка-комбинезон агента
    .desc = Униформа для элитных агентов синдиката, выполняющих тактические операции в глубоком космосе..
    .suffix = { "" }
