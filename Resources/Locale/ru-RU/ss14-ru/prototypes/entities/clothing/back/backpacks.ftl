...
ent-ClothingBackpackERTChaplain = рюкзак священика ОБР
    .desc = Вместительный рюкзак с множеством карманов, который носят священики отряда быстрого реагирования.
