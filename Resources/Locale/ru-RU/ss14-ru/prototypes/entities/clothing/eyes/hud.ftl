...
ent-ClothingEyesEyepatchHudMedical = медицинский визор на глаз
    .desc = Окуляр с индикатором на стекле, который сканирует гуманоидов в поле зрения и предоставляет точные данные о состоянии их здоровья. Для настоящиех патриотов.
ent-ClothingEyesEyepatchHudSecurity = визор охраны на глаз
    .desc = Окуляр с индикатором на стекле, который сканирует гуманоидов в поле зрения и предоставляет точные данные об их идентификационном статусе и записях в системе безопасности. FДля настоящиех патриотов.
ent-ClothingEyesEyepatchHudBeer = пивные очки на глаз
    .desc = Пара солнцезащитных очков, оснащенных сканером реагентов, а также дающих понимание вязкости жидкости во время движения. Для настоящиех патриотов.
