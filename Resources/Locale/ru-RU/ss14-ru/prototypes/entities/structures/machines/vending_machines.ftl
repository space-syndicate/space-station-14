...
ent-VendingMachineChapel = БогоМат
    ...
    .suffix = { "" }
ent-VendingMachineCigs = ТенеСиг Делюкс
...
ent-VendingMachineCola = Прохладительные напитки Робаст
    .desc = Автомат прохладительных напитков, предоставленный компанией Робаст Индастриз, LLC.
    .suffix = { "" }
...
ent-VendingMachineSmartFridge = Умный холодильник
    ...
    .suffix = { "" }
ent-VendingMachineSnack = Ешьбольш Шоколад Корп
    .desc = Автомат с закусками, предосавленный корпорацией Ешьбольш Шоколад, базирующейся на Марсе.
    .suffix = { "" }
...
ent-VendingMachineLawDrobe = ЗаконШкаф
    .desc = Протест! Этот шкаф обеспечивает верховенство закона... и адвокатской одежды...
    .suffix = { "" }
...
ent-VendingMachineAtmosDrobe = АтмосШкаф
    .desc = Этот относительно безызвестный торговый автомат выдаёт одежду для атмосферных техников, на редкость безызвестный должности.
    .suffix = { "" }
