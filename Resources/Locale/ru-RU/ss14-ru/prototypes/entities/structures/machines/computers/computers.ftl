...
ent-ComputerCargoOrdersEngineering = инженерная консоль запросов
    .desc = Используется инженерным отделом для оформления запросов.
ent-ComputerCargoOrdersMedical = медицинская консоль запросов
    .desc = Используется медицинским отделом для оформления запросов.
ent-ComputerCargoOrdersScience = научная консоль запросов
    .desc = Используется научным отделом для оформления запросов.
ent-ComputerCargoOrdersSecurity = консоль запросов службы безопасности
    .desc = Используется службой безопасности для оформления запросов.
ent-ComputerCargoOrdersService = сервисная консоль запросов
    .desc = Используется сервисным отделом для оформления запросов.
ent-ComputerCargoOrders = консоль заказа грузов
    .desc = Используется для оформления запросов и одобрения заказов.
ent-ComputerFundingAllocation = консоль распределения финансов
    .desc = Терминал для контроля распределения поступающих финансов и выплат отделам.
...
ent-ComputerSalvageJobBoard = консоль утилизаторских запросов
    .desc = Консоль для выполнения утилизаторских запросов, если вы достаточно сильный.
