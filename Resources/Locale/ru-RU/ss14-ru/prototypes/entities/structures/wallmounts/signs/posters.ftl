...
ent-PosterContrabandClown = Клоун
    .desc = Хонк.
    .suffix = { "" }
ent-PosterContrabandSmoke = Курение
    .desc = Плакат, рекламирующий марку сигарет конкурирующей компании.
    .suffix = { "" }
ent-PosterContrabandGreyTide = Серая волна
...
ent-PosterContrabandLamarr = Ламарр
    ...
    .suffix = { "" }
ent-PosterContrabandBorgFancy = Блестящие Борги
    .desc = Быть модным может любой борг, нужен только костюм.
    .suffix = { "" }
ent-PosterContrabandBorgFancyv2 = Блестящие Борги, версия 2
