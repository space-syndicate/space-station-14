...
ent-PosterContrabandTools = Инструменты
    .desc = Выглядит как обычная реклама инструментов, но на самом деле это скрытый призыв к диверсиям против корпорации.
...
ent-PosterContrabandFreeDrone = Дроны не рабы
    .desc = Этот плакат посвящён храбрости дрона-изменника, однажды изгнанного, а затем окончательно уничтоженного.
...
ent-PosterContrabandTheBigGasTruth = Правда о газовом гиганте
    .desc = Не верьте всему, что вы видите на плакате. Ни один рептилоид из Центрального командования не хочет отвечать на простой вопрос: ОТКУДА ГАЗ?
