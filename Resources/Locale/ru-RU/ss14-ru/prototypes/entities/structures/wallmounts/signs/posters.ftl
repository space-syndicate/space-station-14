...
ent-PosterLegitOppenhopper = Оппенхоппер
    .desc = Постер давно забытого фильма. В нём рассказывается о группе упорных салаг из сектора Грасхоппер, или Кузнечик, которые противостоят атакам печально известных Ядерных Оперативников. Слоган гласит: «Операции оперативников будут продолжаться, пока робастность не повысится».
