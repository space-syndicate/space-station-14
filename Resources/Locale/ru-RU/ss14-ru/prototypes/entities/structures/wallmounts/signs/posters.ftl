...
ent-PosterContrabandMoth = СиндиМоль — Ядерные операции
    .desc = Плакат, созданный по заказу Синдиката, с использованием СиндиМоли™, призывающий зрителя держать диск ядерной аутентификации незащищенным. "Мир никогда не был вариантом!" Ни один хороший сотрудник не станет прислушиваться к этой чепухе.
