...
ent-PosterLegitSafetyReport = Безопасность: Доносите
...
ent-PosterLegitFoamForceAd = Реклама Foam Force
    .desc = Foam Force, вспень или будь вспененным!
ent-PosterLegitCohibaRobustoAd = Реклама Cohiba Robusto
    .desc = Cohiba Robusto, шикарная сигара.
...
ent-PosterLegitFruitBowl = Фруктовая чаша
...
ent-PosterLegitEnlist = Записывайтесь
...
ent-PosterLegitCarbonDioxide = Углекислый газ
    .desc = Этот информационный плакат рассказывает, что такое углекислый газ.
