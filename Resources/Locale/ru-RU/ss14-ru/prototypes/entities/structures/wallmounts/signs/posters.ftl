...
ent-PosterContrabandGreyTide = Grey Tide
    .desc = Бунтарский плакат, символизирующий сплоченность ассистентов.
    .suffix = { "" }
...
ent-PosterContrabandBorgFancyv2 = Borg Fancy v2
    .desc = Модные Борги, Теперь только самый модные.
    .suffix = { "" }
ent-PosterContrabandKosmicheskayaStantsiya = Kosmicheskaya Stantsiya 13 Does Not Exist
    .desc = Плакат, высмеивающий отрицание ЦентКомом существования заброшенной станции около с Космической станции 13.
    .suffix = { "" }
...
ent-PosterContrabandHaveaPuff = Have a Puff
    .desc = Кого волнует рак лёгких когда ты накуренный как паровоз?
    .suffix = { "" }
...
ent-PosterContrabandSyndicatePistol = Syndicate Pistol
    .desc = Плакат, рекламирующий пистолеты Синдиката как "чертовски классные". Он покрыт выцветшими логотипами банд.
    .suffix = { "" }
...
ent-PosterContrabandPwrGame = Pwr Game
    .desc = ПИТАНИЕ, которого ЖАЖДУТ геймеры! В партнерстве с компанией Vlad's Salad.
    .suffix = { "" }
...
ent-PosterLegitStateLaws = State Laws
    .desc = Плакат, предписывающий киборгам называть свои законы.
    .suffix = { "" }
...
ent-PosterLegitSafetyInternals = Safety: Internals
    .desc = Плакат, напоминающий читателю о необходимости носить скафандр в условиях отсутствия кислорода или отравления воздуха.
    .suffix = { "" }
...
ent-PosterLegitCohibaRobustoAd = Cohiba Robusto Ad
    .desc = Cohiba Robusto, престижная сигара.
    .suffix = { "" }
ent-PosterLegit50thAnniversaryVintageReprint = 50th Anniversary Vintage Reprint
    .desc = Репринт плаката 2505 года, посвященного 50-летию компании Nanoposters Manufacturing, дочерней компании Nanotrasen.
    .suffix = { "" }
...
ent-PosterLegitHighClassMartini = High-Class Martini
    .desc = Я сказал тебе взболтать, не смешивать.
    .suffix = { "" }
