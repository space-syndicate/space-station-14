...
ent-PosterLegitCleanliness = Призыв мыть руки
    .desc = После нескольких эпедемий стали вешать эти плакаты. Как ни странно, это помогло.
...
ent-PosterLegitBuild = Призыв экономить воздух
    .desc = После открытия газодобыдчиков многи и позабыли об экономии воздуха. Печально, что приходится напоминать, что мы вообще-то в космосе.
