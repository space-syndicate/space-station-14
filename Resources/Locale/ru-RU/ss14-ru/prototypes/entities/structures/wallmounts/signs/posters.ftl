...
ent-PosterContrabandSyndicateRecruitment = Смерть СССП
    .desc = Не все были согласны с независмостью и признанием СССП. Они ведут подпольную войну, тайно вербуя людей.
...
ent-PosterContrabandCommunistState = Коммунистическое государство
    .desc = Этот плакат очень старый. Неизвестно, сколько он тут висит, но он ещё был до войны за независимость.
...
ent-PosterLegitHereForYourSafety = Славься СССП!
    .desc = Этот плакат вешали везде после победы. Слава СССП!
ent-PosterLegitNanotrasenLogo = Флаг СССП
    .desc = Плакат с изображением флага СССП.
ent-PosterLegitCleanliness = Призыв мыть руки
    .desc = После нескольких вспышек инфекций стали вешать эти плакаты. Как ни странно, это помогло.
ent-PosterLegitHelpOthers = Помогай окружающим
    .desc = Плакат, призывающий вас помогать членам экипажа.
ent-PosterLegitBuild = Призыв экономить воздух
    .desc = После открытия газодобыдчиков многие и позабыли об экономии воздуха. Печально, что приходится напоминать, что мы вообще-то в космосе.
ent-PosterLegitBlessThisSpess = Боже это место храни
    .desc = Плакат, благославляющий эту область.
ent-PosterLegitScience = Наука
    .desc = Плакат с изображением атома. Наука - наше всё!
ent-PosterLegitIan = Иан
    .desc = Гав гав. Ррав.
ent-PosterLegitObey = Плакат для кадетов
    .desc = Надпись гласит: "Кадет, осторожно: лилипуты крадут патроны"
ent-PosterLegitWalk = Ходите пешком
    .desc = Плакат, призывающий ходить, а не бегать.
ent-PosterLegitStateLaws = Вступай в ряды армии
    .desc = Армия оберегает нас от всех невзгод и от капиталистов, жадно смотрящие в нашу сторону!
ent-PosterLegitLoveIan = Любовь к Иану
    .desc = Иан - любовь, Иан - это жизнь.
ent-PosterLegitSpaceCops = Верь милиции
    .desc = Милиция - неотъемлимая часть нашей станции. Доверяй им, и они помогут, чем смогут.
ent-PosterLegitUeNo = Цой жив!
    .desc = Этот плакат сильно покоцало время, цвета выцвели. Но великий человек всегда с нами, как и этот плакат. Интересно, сколько ему лет?
ent-PosterLegitGetYourLEGS = Пропоганда коммунизма
    .desc = Идеи коммунизма никогда не устареют - это наше светлое будущее!
...
ent-PosterLegitSoftCapPopArt = Щи и каша
    .desc = Как давно вы их ели?
...
ent-PosterLegitCohibaRobustoAd = Хлеб
    .desc = Это классика. Хлеб дешёв в изготовлении и приятен в употреблении, если приготовлен не тяп ляп. Вы чувствуете этот запах? Ммм...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвященного 50-летию компании Nanoposters Manufacturing, дочерней компании Nanotrasen. Почему его не сняли?
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = Этот плакат лишний раз напоминает, что Nanotrasen готовы нагло врать, чтобы скрыть горькую правду, а самое главное - они продолжают устраивать нехорошие вещи.
