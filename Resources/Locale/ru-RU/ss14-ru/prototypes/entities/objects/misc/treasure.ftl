ent-TreasureDatadiskEncrypted = зашифрованный диск данных
    .desc = Старый диск с данными. Кто-то более умнее вас смог бы его расшифровать и узнать что-нибудь интересное. Всё, что вы можете сделать, это продать его.
ent-TreasureHardDiskDrive = жёсткий диск
    .desc = Дисковод, предназначенный для старой земной техники, около 1980 года. Возможно, найдётся какой-нибудь коллекционер, который захочет заполучить его в свои руки.
