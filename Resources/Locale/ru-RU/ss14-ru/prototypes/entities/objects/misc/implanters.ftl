...
ent-BaseImplantOnlyImplanter = { ent-Implanter }
    ...
    .suffix = { "" }
ent-SadTromboneImplanter = имплантер Печальный тромбон
    .desc = Одноразовый имплантер, содержащий имплант, который проигрывает печальную мелодию при смерти владельца.
    .suffix = { "" }
ent-LightImplanter = имплантер Свет
    .desc = Одноразовый имплантер, содержащий имплант, который излучает свет при активации.
    .suffix = { "" }
ent-TrackingImplanter = следящий имплантер
