...
ent-MaterialToothSharkminnow = зуб карпоакулы
    .desc = Выглядит остро. Достаточно остро, чтобы выколоть кому-нибудь глаз. Чёрт возьми, он большой.
    .suffix = Full
...
ent-MaterialGoliathHide = пластины голиафа
    .desc = Куски каменистой шкуры голиафа, могут сделать ваш костюм более устойчивым к атакам местной фауны.
    .suffix = Полный
