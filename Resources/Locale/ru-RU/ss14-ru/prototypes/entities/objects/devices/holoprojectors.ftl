...
ent-HoloprojectorDetective = детективный проектор голобарьера
    .desc = Создаёт твёрдый, но хрупкий барьер. Полезен для оцепления мест преступлений.
ent-HoloprojectorDetectiveEmpty = { ent-HoloprojectorDetective }
    .suffix = Пустой
    .desc = { ent-HoloprojectorDetective.desc }
