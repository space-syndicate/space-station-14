...
ent-XenoborgCameraMonitorCircuitboard = монитор камер наблюдения ксеноборгов (консольная плата)
    .desc = Консольная плата для монитора камер наблюдения ксеноборгов.
