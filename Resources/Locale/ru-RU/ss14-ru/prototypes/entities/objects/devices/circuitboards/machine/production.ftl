...
ent-ThermomachineHeaterMachineCircuitBoard = нагревательная термомашина (машинная плата)
    .desc = Для изменения типа платы можно использовать отвертку.
ent-HellfireFreezerMachineCircuitBoard = адски-морозильная термомашина (машинная плата)
    .desc = Для изменения типа платы можно использовать отвертку.
ent-HellfireHeaterMachineCircuitBoard = адски-нагревательная термомашина (машинная плата)
    .desc = Для изменения типа платы можно использовать отвертку.
