...
ent-WeaponFlareGunSecurity = сигнальное ружьё
    .desc = Модифицированный сигнальный пистолет, изначально предназначенный для использования службой безопасности для запуска нелетальных дробовых снарядов. Однако он также может без риска стрелять и летальными снарядами.
