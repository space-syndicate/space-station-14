...
ent-WeaponRifleAk = АКМС
    .desc = Несколько побитая боевая винтовка, конструкция которой берёт своё начало на старой Земле. Популярна среди преступников, ополченцев и террористов благодаря своей известной надежности и простой конструкции. Использует патроны калибра .30 винтовочный.
    .suffix = Автомат
