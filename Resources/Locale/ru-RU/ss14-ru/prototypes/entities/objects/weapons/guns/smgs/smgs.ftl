...
ent-WeaponSubMachineGunC20rROW = C-20r ROW
    .desc = Пистолет-пулемёт C-20r с режимом стрельбы очередями для использования боргами. На ходу создаёт патроны калибра .35 авто из встроенного самозарядного фабрикатора боеприпасов.
