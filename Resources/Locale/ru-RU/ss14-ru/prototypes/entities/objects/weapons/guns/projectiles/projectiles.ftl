...
ent-BaseBulletHighVelocity = базовая пуля высокоскороскоросная
    .desc = { ent-BaseBullet.desc }
...
ent-BulletDisabler = заряд станнера
    .desc = { ent-BaseBullet.desc }
ent-BulletDisablerPractice = заряд тренировочного стеннар
    .desc = { ent-BaseBullet.desc }
...
ent-BulletGrenadeBlast = фугасная граната
    .desc = { ent-BaseBulletTrigger.desc }
ent-BulletGrenadeFlash = сметошумовая граната
    .desc = { ent-BaseBulletTrigger.desc }
