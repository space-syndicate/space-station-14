...
ent-CyborgEnergySword = { ent-EnergySword }
    .desc = Очень громкий и опасный меч с лучом из чистой концентрированной плазмы. Разработан специально для боргов Синдиката.
    .suffix = Для боргов
ent-CyborgEnergySwordDouble = { ent-EnergySwordDouble }
    .desc = Стажёры из командования Синдиката решили, что одного клинка на энергетическом мече недостаточно. Специальная разработка для боргов Синдиката.
