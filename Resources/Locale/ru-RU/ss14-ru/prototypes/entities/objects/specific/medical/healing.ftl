...
ent-RegenerativeMesh = регенеративная сеть
    .desc = Применяется для лечения даже самых неприятных ожогов. Эффективен также при кислотных ожогах.
...
ent-MedicatedSuture = медицинский шов
    .desc = Шов, пропитанный лекарством, эффективно лечит механические травмы и закрывает раны.
...
ent-SyringeIpecac = шприц ипекака
    .desc = { ent-BaseSyringe.desc }
ent-SyringeAmbuzol = шприц амбузолв
    .desc = { ent-BaseSyringe.desc }
