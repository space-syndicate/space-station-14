...
ent-VendingMachineRestockBooze = набор пополнения БухлоМат
    .desc = Поместите в БухлоМат чтобы начать вечеринку! Не для продажи пассажирам, не достигшим совершеннолетия.
