...
ent-BorgMegaSprayBottle = продвинутый внутренний пульверизатор
    .desc = Усовершенствованная версия встроенного распылителя, установленного непосредственно в уборочного борга. Обычно заполняется космическим очистителем для устранения неприятных луж.
    .suffix = Заполненный
ent-Vapor = пар
    .desc = { "" }
