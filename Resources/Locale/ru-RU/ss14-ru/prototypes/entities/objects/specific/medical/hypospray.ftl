...
ent-PunctAutoInjector = автоинъектор пунктураза
    .desc = Экспресс-доза пунктураза и транексамовой кислоты, предназначена для боевого применения.
ent-PyraAutoInjector = автоинъектор пиразина
    .desc = Экспресс-доза пиразина и дермалина, предназначена для боевого применения.
ent-AirlossAutoInjector = автоинъектор удушения
    .desc = Экспресс-доза физраствора и дексалина плюс, предназначена для того, чтобы быстро поднять кого-нибудь на ноги.
