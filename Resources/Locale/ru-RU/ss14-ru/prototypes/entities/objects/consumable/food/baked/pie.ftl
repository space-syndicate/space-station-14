...
ent-FoodTartGrape = виноградный торт
    .desc = Вкусный десерт, который напомнит вам о вине.
ent-FoodTartMime = мимский торт
    .desc = "      "
ent-FoodTartGapple = торт из золотых яблок с крошкой
    .desc = Вкуснейший десерт, который не пронести через металлоискатель.
ent-FoodTartCoco = шоколадный торт с лавой
