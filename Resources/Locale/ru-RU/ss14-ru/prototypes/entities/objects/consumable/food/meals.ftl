...
ent-FoodMealFriesCheesy = сырный фри
    .desc = Картофель фри. Покрытый сыром. Да.
    .suffix = { "" }
...
ent-FoodMealMint = мята
    ...
    .suffix = { "" }
ent-FoodMealEggplantParm = баклажан пармиджана
...
ent-FoodMealBearsteak = филе-медведьон
    ...
    .suffix = { "" }
ent-FoodMealPigblanket = свинка в тесте
    .desc = Маленькая сосиска, обёрнутая пышной жирной булочкой. Освободите свинку из ее одеяльной тюрьмы, съев ее.
    .suffix = { "" }
...
ent-FoodMealMilkape = молочная обезьяна
    ...
    .suffix = { "" }
ent-FoodMealMemoryleek = лук-течка памяти
