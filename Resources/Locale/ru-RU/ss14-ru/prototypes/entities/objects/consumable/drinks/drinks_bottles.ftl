...
ent-DrinkGoldschlagerBottleFull = бутылка гольдшлягера
    ...
    .suffix = { "" }
ent-DrinkKahluaBottleFull = бутылка калуа
    .desc = Широко известный мексиканский кофейный ликер. Производится с 1936 года, ХОНК.
    .suffix = { "" }
...
ent-DrinkRumBottleFull = кубинский пряный ром капитана Пита
    ...
    .suffix = { "" }
ent-DrinkSpaceMountainWindBottleFull = бутылка космогорного ветра
...
ent-DrinkVodkaBottleFull = бутылка водки
    .desc = А-а-а, водка. Напиток и топливо номер один для Русских во всей галактике.
    .suffix = { "" }
...
ent-DrinkWaterBottleFull = бутылка воды
    .desc = Просто чистая вода неизвестного происхождения. Вы думаете, что, возможно, и не хотите его знать.
    .suffix = { "" }
