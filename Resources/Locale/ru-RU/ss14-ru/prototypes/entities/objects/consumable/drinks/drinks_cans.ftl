...
ent-DrinkTonicWaterCan = банка тоника
    ...
    .suffix = { "" }
ent-DrinkFourteenLokoCan = банка 14 Loko
    .desc = Этикетка гласит что употребление 14 Loko может вызвать судороги, слепоту, опьянение, или даже смерть. Пожалуйста, пейте ответственно.
    .suffix = { "" }
