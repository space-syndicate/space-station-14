...
ent-DrinkSodaWaterCan = банка содовой
    ...
    .suffix = { "" }
ent-DrinkSpaceMountainWindCan = банка космического "маунтин винд"
...
ent-DrinkTonicWaterCan = банка тоника
    ...
    .suffix = { "" }
ent-DrinkFourteenLokoCan = банка 14 Локо
    .desc = Этикетка гласит что употребление 14 Локо может вызвать судороги, слепоту, опьянение, или даже смерть. Пожалуйста, пейте ответственно.
    .suffix = { "" }
