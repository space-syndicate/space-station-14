...
ent-DrinkLemonLimeCan = банка лимон-лайма
    .desc = Вы хотели АПЕЛЬСИНОВЫЙ. А он дал вам лимон-лайм.
    .suffix = { "" }
...
ent-DrinkSodaWaterCan = банка содовой
    ...
    .suffix = { "" }
ent-DrinkSpaceMountainWindCan = банка космогорного ветра
...
ent-DrinkTonicWaterCan = банка тоника
    ...
    .suffix = { "" }
ent-DrinkFourteenLokoCan = банка Четырнадцать Локо
    .desc = Этикетка гласит что употребление Четырнадцать Локо может вызвать судороги, слепоту, опьянение, или даже смерть. Пожалуйста, пейте ответственно.
    .suffix = { "" }
