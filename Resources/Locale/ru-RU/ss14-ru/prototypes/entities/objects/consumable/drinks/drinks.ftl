...
ent-DrinkErikaSurprise = сюрприз Эрики
    ...
    .suffix = { "" }
ent-DrinkFourteenLokoGlass = стакан четырнадцать Локо
    .desc = Это емкость с напитком "Четырнадцать Локо", который выглядит просто отлично. Напиток, а не емкость.
    .suffix = { "" }
...
ent-DrinkIrishCreamGlass = бокал сливок по-ирландски
    ...
    .suffix = { "" }
ent-DrinkKahluaGlass = бокал кахлуа
...
ent-DrinkSpaceUpGlass = стакан спейс-ап
    ...
    .suffix = { "" }
ent-DrinkSpaceMountainWindGlass = стакан космогорного ветра
