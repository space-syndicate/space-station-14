...
ent-FoodDonkpocket = донк-покет
    .desc = Выбор опытного предателя.
    .suffix = { "" }
ent-FoodDonkpocketWarm = теплый донк-покет
    .desc = Разогретый выбор опытного предателя.
    .suffix = { "" }
ent-FoodDonkpocketDank = данк-покет
    .desc = Выбор опытного ботаника.
    .suffix = { "" }
ent-FoodDonkpocketDankWarm = теплый данк-покет
    .desc = Разогретый выбор опытного ботаника.
    .suffix = { "" }
ent-FoodDonkpocketSpicy = спайси-покет
    .desc = Классическая закуска, теперь с острым вкусом, который активируется при нагревании.
    .suffix = { "" }
ent-FoodDonkpocketSpicyWarm = теплый спайси-покет
    .desc = Классическая закуска, теперь, наверное, слишком острая.
    .suffix = { "" }
