...
ent-CrowbarRed = аварийная монтировка
    .desc = Карманный ломик, предназначенный для открывания дверей и замков во время отключения электричества.
...
ent-CrowbarYellow = { ent-BaseCrowbar }
    .desc = Карманный ломик, предназначенный для открывания дверей и замков во время отключения электричества, получаемый инженерами.
