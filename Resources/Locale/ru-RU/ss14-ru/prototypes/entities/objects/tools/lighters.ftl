...
ent-CentCommFlippo = позолоченная флиппо ЦК
    .desc = Изысканная флиппо, с рельефным, нефритовым с позолотой корпусом, турбо-пламя которой создаётся блюспейсом. Кнопка защищена миниатюрным считывателем доступов, который реагирует только на сотрудников Центрального командования. Самая красивая зажигалка, известная человечеству.
    .suffix = НЕ МАППИТЬ
