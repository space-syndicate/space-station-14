...
ent-PlushieLizardInversed = плюшевый хтану
    .desc = Очаровательная мягкая игрушка, напоминающая рептилию из инверсированного измерения. Хев!
...
ent-PlushieSpaceLizard = плюшевая космическая рептилию
    .desc = Очаровательная мягкая игрушка, напоминающая рептилию в ВКД костюме. Изготовлена Центком в рамках показательной инициативы по борьбе с дискриминацией по видовому признаку в рабочей среде. "Приветствуйте своих новых коллег как вы приветствуете эту игрушку, с распростёртыми объятиями!".
