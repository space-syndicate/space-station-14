...
lathe-menu-delete-fabricating-tooltip = Не может распечатать выбранный предмет.
lathe-menu-delete-item-tooltip = Отмена печати этой группы.
lathe-menu-move-up-tooltip = Двигает эту группу вверх очереди.
lathe-menu-move-down-tooltip = Двигает эту группу вниз очереди.
