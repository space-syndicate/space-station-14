...
roles-antag-rev-head-name = Вождь революции
...
roles-antag-rev-objective = Ваша задача - защищать и выполнять приказы Вождей революции, а также уничтожить весь командный состав станции.
rev-break-control =
    { $name } { $gender ->
...
rev-role-greeting =
    Вы - Революционер.
    Вам поручено захватить станцию и защищать Вождей революции.
    Уничтожьте весь командный состав станции.
    Viva la revolución!
rev-briefing = Помогите Вождям революции уничтожить командование станции, чтобы захватить её.
...
rev-no-heads = Нет кандидатов на роль Вождя революции. Нельзя запустить пресет Революционеры.
rev-all-heads-dead = Все главы мертвы, теперь разберитесь с оставшимися членами экипажа!
rev-won = Вожди революции выжили и уничтожили весь командный состав станции.
rev-headrev-count =
    { $initialCount ->
        [one] Вождь революции был один:
       *[other] Вождей революции было { $initialCount }:
    }
rev-headrev-player =
...
rev-lost = Члены командного состава станции выжили и уничтожили всех Вождей революции.
rev-stalemate = Вожди революции и командный состав станции погибли. Это ничья.
rev-reverse-stalemate = Вожди революции и командный состав станции выжили.
