thief-role-greeting-human =
    ...
    ранее арестованный за мелкую кражу и досрочно освобождённый.
    Вам необходимо пополнить свою коллекцию.
#    После предыдущего ареста вам насильно вживили имплант пацифизма,
#    но это не остановит вас от удовлетворения своих желаний любым способом. // Corvax-MRP
