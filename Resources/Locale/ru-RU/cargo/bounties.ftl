...
bounty-description-tooth-space-carp = Некоторым парням из "нижней унды" нужны зубы для изготовления их традиционной одежды. Пришлите им парочку от космических карпов.
