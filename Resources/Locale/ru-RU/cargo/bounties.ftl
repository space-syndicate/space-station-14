...
bounty-description-bedsheet = Кто-то в Атмос-отсеке постоянно выключает обогреватель, и мы всё мёрзнем в наших кроватях. Пожалуйста, пришлите нам несколько дополнительных одеял, чтобы мы могли согреться.
