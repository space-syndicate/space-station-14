...
round-end-system-shuttle-auto-called-announcement = Автоматический шаттл для смены экипажа был отправлен. Расчётное время прибытия: { $time } { $units }. Чтобы продлить смену, отзовите шаттл.
