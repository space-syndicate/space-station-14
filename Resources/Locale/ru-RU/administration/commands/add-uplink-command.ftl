...
add-uplink-command-completion-1 = Юзернейм (по-умолчанию это вы сами)
add-uplink-command-completion-2 = Аплинк uid (по-умолчанию это КПК)
add-uplink-command-error-1 = Выбранный игрок не управляет никакой сущностью
