...
admin-smite-lung-removal-self = Вы не можете вздохнуть!
...
admin-smite-vomit-organs-description = Вызывает у цели рвоту, и органами тоже.
admin-smite-remove-hands-description = Лишает цель рук.
admin-smite-pinball-description = Превращает цель в суперпрыгучий мяч, толкая цель, пока она не клипнется сквозь станцию в бездну.
...
admin-trick-make-indestructible-description = Делает указанный объект неуязвимым, фактически godmode.
admin-trick-make-vulnerable-description = Делает указанный объект уязвимым снова, отключая godmode.
admin-trick-block-unanchoring-description = Не даёт закрепить указанный объект.
admin-trick-refill-battery-description = Перезаряжает батарею указанного объекта.
admin-trick-drain-battery-description = Разряжает батарею указанного объекта.
