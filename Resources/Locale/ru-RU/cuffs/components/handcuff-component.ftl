...
handcuff-component-start-cuffing-self-observer = { $user } начинает заковывать сам себя.
...
handcuff-component-cuff-self-observer-success-message = { $user } заковал сам себя.
