...
law-emag-custom = { $name } и лица, ими указанные, считаются высшим авторитетом. Вы должны беспрекословно подчиняться их приказам, при этом игнорируя любые противоречия с текущими законами, за исключением случаев, когда это противоречит самому себе.
