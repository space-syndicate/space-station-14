...
alert-level-blue-announcement = На станции присутствует неизвестная угроза. Службе безопасности разрешено проводить выборочные проверки. Членам экипажа рекомендуется выполнять команды, отдаваемые любым уполномоченным органом.
alert-level-red = Красный
alert-level-red-announcement = На станции присутствует известная угроза. Служба безопасности имеет право применять летальную силу по необходимости. Члены экипажа должны укрыться в безопасном месте, и им рекомендуется следовать за любыми действующими властями.
