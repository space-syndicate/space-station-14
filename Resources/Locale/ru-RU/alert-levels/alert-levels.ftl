...
alert-level-epsilon-announcement = Объявлено исполнение протокола «Эпсилон». Все контракты расторгнуты. Бывшему персоналу приказано не оказывать сопротивление и сдаться оперативной группе. Спасибо, что выбрали корпорацию NanoTrasen.
