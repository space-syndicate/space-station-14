...
alert-level-lockdown-announcement = Центральное командование объявило полный локдаун станции. Весь персонал должен проследовать в свой отдел. Сотрудникам службы безопасности разрешено использование летального оружия.
