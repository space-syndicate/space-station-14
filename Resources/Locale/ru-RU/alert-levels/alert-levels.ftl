...
alert-level-omega-announcement = Центральное командование объявило на станции уровень угрозы "Омега". Присутствует большая биологическая угроза на борту станции. Членам экипажа следует изолироваться и ждать дальнейших указаний от центрального командования. Все заражённые если такие есть, должны быть уничтожены! Любые стыковки станции с другими объектами категорически запрещены иначе вы будете уничтожены. Службе безопасности разрешено использование летальной силы в случае неповиновения!
alert-level-omega-instructions = Членам экипажа следует изолироваться и ждать дальнейших указаний от центрального командования.
