...
alert-level-sintwave-announcement = Поздравляем! Центральное командование выбрало вашу станцию для проведения эксперимента "Синтвейв". Весь персонал освобождается от своих обязанностей. Новая цель смены, веселиться.
alert-level-sintwave = Синтвейв
alert-level-sintwave-announcement = Центральное командование объявило на станции уровень угрозы "Синтвейв". Весь персонал освобождается от своих обязанностей и обязан веселиться. HONK TIME!
