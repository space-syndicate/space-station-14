...
ghost-command-help-text =
    Команда ghost превращает вас в призрака, а персонажа, которым вы играли, навсегда становится кататоником.
    Обратите внимание, что это действие необратимо, и вы не сможете вернуться в тело своего персонажа.
ghost-command-no-session = Вы не в сеансе, вы не можете призрака.
