...
wires-component-ui-on-receive-message-cannot-cut-cut-wire = Вы не можете перерезать перерезанный провод!
wires-component-ui-on-receive-message-cannot-mend-uncut-wire = Вы не можете соединить соединённый провод!
