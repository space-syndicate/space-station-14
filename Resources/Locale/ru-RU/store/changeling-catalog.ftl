...
changeling-catalog-voice-mindshield-desc = Модифицируйте естественные волны ваших нейронов, чтобы они копировали волны, генерируемые имплантатами защиты разума Nanotrasen, благодаря чему вы будете выглядеть имплантированным Щитом разума в глазах сотрудников службы безопасности. Можно включить/выключить.
