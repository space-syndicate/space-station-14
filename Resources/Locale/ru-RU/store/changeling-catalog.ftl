...
changeling-catalog-blind-sting-desc = Вызывает временную слепоту у цели. Хорошо подходит для побега или начала драки. Может быть использован на себе.

changeling-catalog-cryogenic-sting-name = Охлаждающее жало
changeling-catalog-cryogenic-sting-desc = Вызывает замедление движения у цели. Идеально подходит для предотвращения побега добычи. Может быть использован на себе.

changeling-catalog-lethal-sting-name = Отравляющее жало
changeling-catalog-lethal-sting-desc = Наносит очень медленный урон цели. Бесполезен в бою, но гарантирует, что им потребуется медицинская помощь. Может быть использован на себе.

changeling-catalog-hallucinogenic-sting-name = Галлюциногенное жало
changeling-catalog-hallucinogenic-sting-desc = Вызывает у жертвы состояние эйфории и затруднения в речи. Вызывает замешательство среди экипажа. Может быть использован на себе.
