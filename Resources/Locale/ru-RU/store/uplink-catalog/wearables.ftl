...
uplink-hardsuit-syndieelite-desc = Модифицированная версия кроваво-красного скафандра, заменив некоторую баллистическую защиту на высокую устойчивость к взрывам, энергетическому оружию и самым экстремальным атмосферным условиям. Используется настоящей элитой.
