...
uplink-emag-desc = Он же ЕМАГ, визитная карточка Синдиката. Устройство взлома, способное взламывать различные станционные устройства. Примечательно, что он способен взламывать несанкционированные системы безопасности на автолатах и конвертировать киборгов с открытыми панелями доступа. Перезаряжается автоматически.
...
uplink-syndicate-weapon-module-desc = Модернизирует киборга с помощью энергетического кинжала и пистолета Кобра, с самовоспроизводящимися боеприпасами.
