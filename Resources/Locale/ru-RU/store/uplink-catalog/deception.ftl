...
uplink-cyberpen-desc = Ручка с алмазным наконечником, используемая юридическим отделом Cybersun. Может использоваться для внесения изменений в проштампованные документы, нанесения смертельных ударов прокурорам и в качестве отвертки в крайнем случае. Этот незаменимый инструмент для наживы на войне сильнее многих мечей.
