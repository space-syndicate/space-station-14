...
uplink-storage-implanter-desc = Чудо блюспейса, способное спрятать содержимое, эквивалентное двум пистолетам. Сразу же полезно для хранения пустого имплантатора.
...
uplink-uplink-implanter-desc = Незаметно заказывайте снаряжение без использования КПК. Приложите телекристаллы прямо ко лбу, чтобы перевести их на свой BitCrystal счёт!
