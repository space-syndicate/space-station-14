...
uplink-reinforcement-radio-desc = Телепортирует агента крайне сомнительного качества. Не имеет кнопки отключения, покупайте его, если вы готовы веселиться. У агента есть пистолет без запасных патронов и нож. Вот и всё.
