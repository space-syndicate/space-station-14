...
uplink-eva-syndie-desc = Простой EVA-скафандр, который не даёт никакой защиты, кроме той, что необходима для выживания в космосе. (Поставляется с боевыми перчатками и боевой маской Синдиката.)
