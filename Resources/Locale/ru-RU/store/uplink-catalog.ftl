...
uplink-hushpup-desc = Мощное бесшумное ружье с малой емкостью магазина. В комплекте запасная коробка картечи. Использует патроны калибра .50 для дробовика.
# Explosives
...
uplink-voice-mask-implanter-desc = Модифицирует ваши голосовые связки, позволяя вам звучать так, как вы только можете себе представить.
# Bundles
