...
New-Item -ItemType Junction -Path "Resources\Locale\ru-RU\ASalut" -Target "SalutResourses\Locale\ru-RU"
Remove-Item -Path "C:\Users\rg10008\source\GameComplect\space-station-14\Resources\Locale\ru-RU\Job" -Recurse
New-Item -ItemType Junction -Path "Resources\Locale\ru-RU\Job" -Target "SalutResourses\Locale\ru-RU"
