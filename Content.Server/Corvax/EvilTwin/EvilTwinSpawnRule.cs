...
public sealed class EvilTwinSpawnRule : StationEventSystem<EvilTwinSpawnRuleComponent>
{
    /*
     * DO NOT COPY PASTE THIS TO MAKE YOUR MOB EVENT. // he he
     * USE THE PROTOTYPE.
     */


    protected override void Started(EntityUid uid, EvilTwinSpawnRuleComponent component, GameRuleComponent gameRule, GameRuleStartedEvent args)
    {
        ...
        var locations = EntityQueryEnumerator<EvilTwinSpawnLocationComponent, TransformComponent>();
