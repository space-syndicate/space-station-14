...
public sealed class RandomGiftSystem : EntitySystem
{
    ...
    private void BuildIndex()
    {
        ...
        {
            if (proto.Abstract || proto.NoSpawn || proto.Components.ContainsKey(mapGridCompName) || proto.DontPresent || !proto.Components.ContainsKey(physicsCompName)) /// Вставлено в оригинальный код
                continue;
